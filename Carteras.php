...
<body>
	...
	<form action="registrarCartera.php" method="post" class="form-horizontal">
	<input type="text" id="nombre" name="nombre" class="form-control" placeholder="Nombre" required><br>
	<input type="number" step="any" id="monto" name="monto" class="form-control" placeholder="Monto" required><br>
    ...
    <div class="container">
		...
		<?php
			...
			$resultSet = $conn->query("SELECT carteraNombre, carteraMonto FROM cartera");
			$conn -> close();
		?>
		...
		<?php
			while($rows = $resultSet->fetch_assoc())
			{
				...
				$car_monto = $rows['carteraMonto'];
				echo "<tr><td>$car_nombre</td><td>$car_monto</td><tr>";
			}
		?>
		</table><br><br>
	</div>
